<template>
  <nav class="flex items-center justify-between flex-wrap bg-gray-800 p-6 w-full z-10 top-0">
		...
		<div class="block lg:hidden">
			<button @click="ToggleMenu()" id="nav-toggle" class="flex items-center px-3 py-2 border rounded text-gray-500 border-gray-600 hover:text-white hover:border-white">
